...
- Next.js: It is used for both the frontend and the backend of the application.
- Tailwind CSS: Used for styling the application.
- TypeScript: A statically typed superset of JavaScript.
- Mongoose: It is used for defining the product schema and interacting with the MongoDB database.
...
- Cheerio: It is used for parsing the HTML response from the Amazon product page.
...
1. **Clone the repository**
   ...
   ```bash 
   git clone https://github.com/pranav1282/webScrapper-NextJS.git
   ```
